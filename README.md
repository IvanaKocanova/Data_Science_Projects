...
* [Predicting Boston house prices](https://github.com/IvanaKocanova/Data_Science_Projects/blob/master/House_price_prediction_Linear_regression.ipynb)  (work in progress) : I have decided to become a real estate agent for a day! In order to compete with other agents, I have used the power of Multiple Linear Regression and Decision Trees. 
